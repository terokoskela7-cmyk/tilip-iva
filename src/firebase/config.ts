...
// ignoreUndefinedProperties: valinnaiset kentät (esim. tyhjä Y-tunnus) välitetään
// komponenteista undefined-arvoina. Ilman tätä Firestore heittää
// "Unsupported field value: undefined" ja koko tallennus epäonnistuu.
